...
def gen_layout_eckhart(gen_c: bool = False):
    ...
    FaceProcessor("TTSatoshi", "Regular", 20, ext="otf", font_idx=3).write_files(gen_c)
    FaceProcessor("RobotoMono", "Medium", 38, font_idx=3).write_files(gen_c)
    FaceProcessor("RobotoMono", "Light", 30, font_idx=3).write_files(gen_c)
