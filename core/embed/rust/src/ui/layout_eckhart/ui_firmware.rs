...
use super::{
    component::{
        ActionBar, Bip39Input, Button, FormattedScreen, Header, Hint, MnemonicKeyboard,
        PinKeyboard, Slip39Input,
    },
...
impl FirmwareUI for UIEckhart {
    fn confirm_action(
        ...
        let formatted_text = {
            let ops = if !reverse {
                ...
                OpTextLayout::new(theme::TEXT_NORMAL)
                    ...
                    .newline()
                    .text(description, fonts::FONT_SATOSHI_MEDIUM_26)
            } else {
                OpTextLayout::new(theme::TEXT_NORMAL)
                    .text(description, fonts::FONT_SATOSHI_MEDIUM_26)
                    .newline()
        ...
        let screen = FormattedScreen::new(formatted_text)
