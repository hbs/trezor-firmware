...
/// Full-screen component for rendering FormattedText. The
/// component wraps the full content of the generic page spec:
/// - Header
/// - Text
/// - Hint (Optional)
/// - Action bar
pub struct FormattedScreen {
    header: Header,
...
pub enum FormattedScreenMsg {
    Cancelled,
    Confirmed,
}

impl FormattedScreen {
...
impl Component for FormattedScreen {
    type Msg = FormattedScreenMsg;
    ...
    fn event(&mut self, ctx: &mut EventCtx, event: Event) -> Option<Self::Msg> {
        ...
        match msg {
            Some(ActionBarMsg::Cancelled) => Some(FormattedScreenMsg::Cancelled),
            Some(ActionBarMsg::Confirmed) => Some(FormattedScreenMsg::Confirmed),
...
impl crate::trace::Trace for FormattedScreen {
