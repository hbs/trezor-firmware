use crate::{
    ...
    ui::{
        ...
        layout_eckhart::component::theme,
        shape::{self, Renderer},
    },
};
...
pub const KEYBOARD_KEYPAD_HEIGHT: i16 = 440;
/// Visible area of the input field. The touchable area is smaller
pub const KEYBOARD_INPUT_HEIGHT: i16 = 114;
pub const KEYBOARD_INPUT_TOUCH_HEIGHT: i16 = 96;

const PROMPT_HEIGHT: i16 = 44;
const INPUT_HEIGHT: i16 = 72;
const RL_INSET: i16 = 24;
const TOP_PROMPT_INSET: i16 = 35;
const TOP_INPUT_INSET: i16 = 16;

pub const KEYBOARD_PROMPT_INSETS: Insets = Insets::new(
    TOP_PROMPT_INSET,
    RL_INSET,
    KEYBOARD_INPUT_HEIGHT - TOP_PROMPT_INSET - PROMPT_HEIGHT,
    RL_INSET,
);
...
pub const KEYBOARD_INPUT_INSETS: Insets = Insets::new(
    TOP_INPUT_INSET,
    RL_INSET,
    KEYBOARD_INPUT_TOUCH_HEIGHT - TOP_INPUT_INSET - INPUT_HEIGHT,
    RL_INSET,
);
